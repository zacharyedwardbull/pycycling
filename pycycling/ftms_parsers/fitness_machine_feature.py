def parse_fitness_machine_feature(message: bytearray) -> dict:
    ...
    return {
        "avg_speed_supported": avg_speed_supported,
        "cadence_supported": cadence_supported,
        "total_distance_supported": total_distance_supported,
        "inclination_supported": inclination_supported,
        "elevation_gain_supported": elevation_gain_supported,
        "pace_supported": pace_supported,
        "step_count_supported": step_count_supported,
        "resistance_level_supported": resistance_level_supported,
        "stride_count_supported": stride_count_supported,
        "expended_energy_supported": expended_energy_supported,
        "heart_rate_measurement_supported": heart_rate_measurement_supported,
        "metabolic_equivalent_supported": metabolic_equivalent_supported,
        "elapsed_time_supported": elapsed_time_supported,
        "remaining_time_supported": remaining_time_supported,
        "power_measurement_supported": power_measurement_supported,
        "force_on_belt_and_power_output_supported": force_on_belt_and_power_output_supported,
        "user_data_retention_supported": user_data_retention_supported,
    }
